...
import { PUBLIC_INPUT_GEOCODER, PUBLIC_INPUT_CATEGORY, PUBLIC_INPUT_COMMUNE, PUBLIC_INPUT_FACILITY, PUBLIC_INPUT_SEARCH, PUBLIC_INPUT_SITUATION, PUBLIC_BLOG_URI, PUBLIC_VITE_TIMELINE, PUBLIC_ENTRIES_LIMIT, PUBLIC_DEFAULT_LANGUAGE} from '$env/static/public';
...
const DEFAULT_LANGUAGE = PUBLIC_DEFAULT_LANGUAGE;
...
const ENTRIES_LIMIT: number = parseInt(PUBLIC_ENTRIES_LIMIT);
