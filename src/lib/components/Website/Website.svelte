<script lang="ts">
	...
	let {
		...
		appBar = false,
		appRail = false
	}: { website: Website; appBar?: boolean; appRail?: boolean } = $props();
...
{:else if appRail}
	<AppRailAnchor href={website.url} rel="external" class="lg:hidden">
		<svelte:fragment slot="lead"
			><Fa icon={faGlobe} size="lg" class="inline-block outline-none" /></svelte:fragment
		>
