<script lang="ts">
	...
	import { getSelectFacility, getSelectCategories, getTerm, getSelectedCommunesUids, getSelectedDepartments, getSelectSituation, getSelectedTags, getAddressFeature, getDisplayMap } from './context';
